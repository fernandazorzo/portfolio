...
const i18n = {
  ...
  'proj5-title': { pt: 'Social Media - Southair', en: 'Social Media - Southair' },
  'proj5-tag': { pt: 'Social Media', en: 'Social Media' },
  'proj5-desc': { pt: 'A Southair é uma marca premium de cabelos humanos para mega hair, reconhecida pela qualidade de seus produtos e sua atuação internacional. Seu posicionamento une o luxo minimalista europeu à autenticidade, fortalecendo sua autoridade por meio de conteúdos sofisticados que geram desejo e impulsionam vendas.', en: 'Southair is a premium human hair extensions brand, recognized for product quality and international presence. Its positioning unites European minimalist luxury with authenticity, strengthening its authority through sophisticated content that builds desire and drives sales.' },
