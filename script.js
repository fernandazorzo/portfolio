...
const i18n = {
  ...
  'serv-art-i1': { pt: 'Direção de arte & conceituação', en: 'Art direction & conceptualization' },
  'serv-art-i2': { pt: 'Design editorial & layout', en: 'Editorial & layout design' },
  'serv-art-i3': { pt: 'Campanhas visuais', en: 'Visual campaigns' },
  'serv-art-i4': { pt: 'Motion & ilustração', en: 'Motion & illustration' },
  ...
  'serv-id-i1': { pt: 'Estratégia de marca & posicionamento', en: 'Brand strategy & positioning' },
  'serv-id-i2': { pt: 'Sistema de logo & brandmark', en: 'Logo & brandmark system' },
  'serv-id-i3': { pt: 'Paleta de cores & tipografia', en: 'Color palette & typography' },
  'serv-id-i4': { pt: 'Diretrizes de marca', en: 'Brand guidelines' },
  ...
  'serv-social-i1': { pt: 'Criação de conteúdo visual', en: 'Visual content creation' },
  'serv-social-i2': { pt: 'Estratégia de feed & stories', en: 'Feed & stories strategy' },
  'serv-social-i3': { pt: 'Identidade visual para redes', en: 'Visual identity for social media' },
  'serv-social-i4': { pt: 'Calendário editorial', en: 'Editorial calendar' },
